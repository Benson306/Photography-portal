...
<?php 
                                $sql3 = "SELECT * FROM photographer_users WHERE email = '$email'";
...
<body>
	...
	<center>
		...
		<h3>Fill out the Form Below To Complete Creating your account:</h3>
	<center>
...
if(isset($_POST['submit'])){
	...
	if(move_uploaded_file($_FILES["image"]["tmp_name"], $target)){
		...
		$sql= "INSERT INTO photographer_details (email, name, p_type, max_price, phone_number, address, location, image)
		VALUES('$email', '$username', '$p_type', '$price', '$phone', '$address', '$location','$file')";
